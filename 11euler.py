...
# The following is a brute force attack on this problem (is there a better way?). This problem is similar to
# problem 8 in the Euler set except the numbers aren’t adjacent, they separated by a specific amount

import time

start = time.time()
# Creat'e the grid (matrix)
matrix = []  # a python list containing strings for each row
